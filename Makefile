#############################################################################
# Makefile for building: opendaq
# Generated by qmake (2.01a) (Qt 4.6.3) on: ?? ???. 28 00:24:10 2010
# Project:  opendaq.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile opendaq.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Iincludes -InewConfigDialog -IprocessDialog -I/usr/include/qwt-qt4 -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -lqwt-qt4 `libusb-config --libs` -L/usr/lib -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: opendaq.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile opendaq.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/opendaq1.0.0 || $(MKDIR) .tmp/opendaq1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/opendaq1.0.0/ && $(COPY_FILE) --parents mainwindow.h mwindow.h includes/dconfig.h includes/dcurve.h includes/dpack.h includes/dsaver.h includes/dthread.h includes/uhandler.h newConfigDialog/configdialog.h processDialog/processdialog.h .tmp/opendaq1.0.0/ && $(COPY_FILE) --parents main.cpp mwindow.cpp includes/dconfig.cpp includes/dcurve.cpp includes/dsaver.cpp includes/dthread.cpp includes/uhandler.cpp newConfigDialog/configdialog.cpp processDialog/processdialog.cpp .tmp/opendaq1.0.0/ && $(COPY_FILE) --parents mainwindow.ui newConfigDialog/configdialog.ui processDialog/processdialog.ui .tmp/opendaq1.0.0/ && (cd `dirname .tmp/opendaq1.0.0` && $(TAR) opendaq1.0.0.tar opendaq1.0.0 && $(COMPRESS) opendaq1.0.0.tar) && $(MOVE) `dirname .tmp/opendaq1.0.0`/opendaq1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/opendaq1.0.0
